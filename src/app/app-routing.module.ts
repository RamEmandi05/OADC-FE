...
const routes: Routes = [
  { path: '', redirectTo: 'login/v3', pathMatch: 'full' },//dashboard/v3
  ...
  { path: 'ui/icon-fontawesome', component: UIIconFontAwesomePage, data: { title: 'UI Icons' } },
  ...
  { path: 'extra/coming-soon', component: ExtraComingSoonPage, data: { title: 'Coming Soon Page Ram' } },
  ...
  { path: 'organizations', loadChildren: () => import('./pages/organizations/organizations.module').then(m => m.OrganizationsModule), canActivate: [AuthguardService] },
   
  { path: 'permissions', loadChildren: () => import('./pages/admin/permissions.module').then(m => m.PermissionsModule), canActivate: [AuthguardService] },
   
 
  { path: 'registration', component: RegistrationComponent, data: { title: 'Registration' } },
     
  // { path: 'Notifications', component: NotificationsComponent, data: { title: 'Admin Notifications' }, canActivate: [AuthguardService] },  
  
  { path: 'confirmation', component: ConfirmationPageComponent, data: { title: 'Confirmation Page' } },
  { path: 'oadc-users', loadChildren: () => import('./pages/oadc-users/oadc-users.module').then(m => m.OadcUsersModule) },
  { path: 'oadc-camp', loadChildren: () => import('./pages/oadc-camp/oadc-camp.module').then(m => m.OadcCampModule) },
  { path: 'oadc-appointments', loadChildren: () => import('./pages/oadc-appointments/oadc-appointments.module').then(m => m.OadcAppointmentsModule) },
 
 
  { path: '**', component: ExtraErrorPage }
