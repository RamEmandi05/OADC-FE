...
if(localStorage.userprofile != null) {
  //debugger;
  let loggedInUserProfile = JSON.parse(localStorage.userprofile);
  if(loggedInUserProfile.role=="Adminr") {  
    appMenus.push(
      {
        'icon': 'fa fa-building',
        'url':'organizations',
        ...
        'title': 'Data',
        'url': 'organizations/uploads'
        }
      );
   }
  if(loggedInUserProfile.role=="Admin"  || loggedInUserProfile.role=="Recruiter" || loggedInUserProfile.role=="OrganizationAdmin" || loggedInUserProfile.role=="OrganizationViewer" ) {  
    appMenus.push(    
      { 
      'icon': 'fa fa-sitemap',
      'title': 'Dashboard',
      ...
      'title': 'Funds/Hours Approval',
      'url': 'FundsHoursApproval'
      }, 
      { 
      ...
      'title': 'Impersonate a Contractor',
      'url': 'Impersonate a Contractor'
      },
      { 
